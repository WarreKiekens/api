<?php
  ...
  function get_details_city($id){
    ...
    $query = "SELECT id,gebruikersnaam,naam,postcode,isactief,isnew,emailadres,(select count(influencerid) from InfluencerStad where stadid = stad.id) as influencercount, picture FROM stad where id = $1";
